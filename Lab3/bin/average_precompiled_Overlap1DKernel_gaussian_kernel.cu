...
__global__ void average_precompiled_Overlap1DKernel_gaussian_kernel_MapOverlapKernel_CU(
	unsigned char* input, const skepu::Vec<float> stencil, unsigned long elemPerPx,  unsigned char* output,
...
__global__ void average_precompiled_Overlap1DKernel_gaussian_kernel_MapOverlapKernel_CU_Matrix_Row(
	unsigned char* input, const skepu::Vec<float> stencil, unsigned long elemPerPx,  unsigned char* output,
...
__global__ void average_precompiled_Overlap1DKernel_gaussian_kernel_MapOverlapKernel_CU_Matrix_ColMulti(
	unsigned char* input, const skepu::Vec<float> stencil, unsigned long elemPerPx,  unsigned char* output,
